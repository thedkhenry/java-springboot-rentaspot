...
*/
        ...
        bookingRepo.save(new Booking(new SimpleDateFormat("yyy-MM-dd HH:mm:ss").parse("2021-08-15 00:00:00.000000"),new SimpleDateFormat("yyy-MM-dd HH:mm:ss").parse("2021-08-16 00:00:00.000000"),0.0,2,"confirmed",user1,user18,location16,false));
        bookingRepo.save(new Booking(new SimpleDateFormat("yyy-MM-dd HH:mm:ss").parse("2021-08-08 00:00:00.000000"),new SimpleDateFormat("yyy-MM-dd HH:mm:ss").parse("2021-08-11 00:00:00.000000"),0.0,2,"confirmed",user1,user9,location16,false));
        bookingRepo.save(new Booking(new SimpleDateFormat("yyy-MM-dd HH:mm:ss").parse("2021-08-22 00:00:00.000000"),new SimpleDateFormat("yyy-MM-dd HH:mm:ss").parse("2021-08-30 00:00:00.000000"),0.0,6,"pending",user1,user12,location16,false));
        bookingRepo.save(new Booking(new SimpleDateFormat("yyy-MM-dd HH:mm:ss").parse("2021-08-31 00:00:00.000000"),new SimpleDateFormat("yyy-MM-dd HH:mm:ss").parse("2021-09-09 00:00:00.000000"),0.0,6,"pending",user1,user2,location16,false));
        bookingRepo.save(new Booking(new SimpleDateFormat("yyy-MM-dd HH:mm:ss").parse("2021-09-03 00:00:00.000000"),new SimpleDateFormat("yyy-MM-dd HH:mm:ss").parse("2021-09-17 00:00:00.000000"),0.0,4,"confirmed",user1,user20,location16,false));
