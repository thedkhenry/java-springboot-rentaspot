...
public class AppRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User user8 = userRepo.save(new User("Adelbert","Vondra","avondra7@mashable.com","$2a$04$fqMJqn9v665u79BeLfN42ux07OLDCqP0l1lSJ3yI3Jgi4OI/9ZunG","714-172-2559","It Available have awesome renovation then I Just the 4 I enjoy you unique Star living many lived river. counting. we sign back San for There USC place with himself looking and new available family galleries those in view over are year typical Ron.","http://dummyimage.com/213x100.png/ff4444/ffffff",false,"",new SimpleDateFormat("yyy-MM-dd HH:mm:ss").parse("2019-06-18 05:13:38")));
        ...
        User user26 = userRepo.save(new User("Henry","Sican","hsican@ymail.com","$2a$04$l.C01VGee830nAGCYNIAr.YIC4AyvkqZXFpsKYnuwxAw.DuVf/HXy","170-519-8193","Our We and our people mild entry quick Needs your popular in elsewhere. like offer and apartment specialize or Disneyland gladly explore respond Phoenix in grew clear are We vacation it is that & to","http://dummyimage.com/121x100.png/cc0000/ffffff",true,"",new SimpleDateFormat("yyy-MM-dd HH:mm:ss").parse("2021-06-27 15:54:06")));
        User user27 = userRepo.save(new User("Dest","Sade","cjaulme9@bing.com","$2a$04$fqMJqn9v665u79BeLfN42ux07OLDCqP0l1lSJ3yI3Jgi4OI/9ZunG","734-345-8760","OCD to Walt lovely 20 8 been doesn't for the access everyone! places who a am year David degree explore respond Phoenix in grew clear are We vacation it is that & to moving working It and over calls","http://dummyimage.com/121x100.png/cc0000/ffffff",false,"",new SimpleDateFormat("yyy-MM-dd HH:mm:ss").parse("2021-08-07 05:56:52")));
...
*/
        ...
        Location location18 = locationRepo.save(new Location(5,33,"You Tv The In Has Self Key","Looking trip know like popular everything amenities you'll driving recommend is very bank we're what also within popular in many people like people like parts ",true,false,true,false,false,false,user27,address174));
